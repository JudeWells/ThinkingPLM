#!/bin/bash
#SBATCH --job-name=bench_4ZQK_PD-L1_3helix_proposal_bandit
...
cd "$WORKDIR"
python "$WORKDIR/run_profam_bagel_pipeline.py" --config "$WORKDIR/configs/pipelines/bench_4ZQK_PD-L1_3helix_proposal_bandit.yaml"
