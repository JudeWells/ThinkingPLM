#!/bin/bash
#SBATCH --job-name=bench_1YCR_MDM2_3helix_proposal_bandit
...
cd "$WORKDIR"
python "$WORKDIR/run_profam_bagel_pipeline.py" --config "$WORKDIR/configs/pipelines/bench_1YCR_MDM2_3helix_proposal_bandit.yaml"
