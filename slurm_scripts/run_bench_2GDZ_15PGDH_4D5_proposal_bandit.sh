#!/bin/bash
#SBATCH --job-name=bench_2GDZ_15PGDH_4D5_proposal_bandit
...
cd "$WORKDIR"
python "$WORKDIR/run_profam_bagel_pipeline.py" --config "$WORKDIR/configs/pipelines/bench_2GDZ_15PGDH_4D5_proposal_bandit.yaml"
