#!/bin/bash
#SBATCH --job-name=bench_2GDZ_15PGDH_ankyrin_profam_update
...
cd "$WORKDIR"
python "$WORKDIR/run_profam_bagel_pipeline.py" --config "$WORKDIR/configs/pipelines/bench_2GDZ_15PGDH_ankyrin_profam_update.yaml"
