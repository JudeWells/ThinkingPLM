#!/bin/bash
#SBATCH --job-name=bench_2GDZ_15PGDH_nanobody_profam_frozen
...
cd "$WORKDIR"
python "$WORKDIR/run_profam_bagel_pipeline.py" --config "$WORKDIR/configs/pipelines/bench_2GDZ_15PGDH_nanobody_profam_frozen.yaml"
