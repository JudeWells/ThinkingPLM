#!/bin/bash
#SBATCH --job-name=bench_1YCR_MDM2_random_init_profam_frozen
...
cd "$WORKDIR"
python "$WORKDIR/run_profam_bagel_pipeline.py" --config "$WORKDIR/configs/pipelines/bench_1YCR_MDM2_random_init_profam_frozen.yaml"
